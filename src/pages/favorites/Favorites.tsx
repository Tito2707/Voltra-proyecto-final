  ...
  return (
    <div className="min-h-screen bg-voltra-bg">
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-b from-voltra-bg/60 via-voltra-bg/40 to-voltra-bg"></div>
        </div>
              ...
              <div key={originalIndex} className="relative">
                <div className="bg-voltra-bg rounded-xl overflow-hidden shadow-lg w-full text-voltra-text border border-voltra-text/10 transition-transform transform hover:scale-105 flex flex-col">
                  ...
                  <button
                    ...
                    style={{
                      background: "var(--color-voltra-accent)",
                      border: "none",
                      outline: "none",
                      boxShadow:
                        "0 4px 12px color-mix(in srgb, var(--color-voltra-accent) 35%, transparent)",
                    }}
                  >
                    <svg
                      className="w-50 h-50"
                              ...
                              <svg
                                ...
                                fill={
                                  star <= game.ranking_estrellas
                                    ? "var(--color-voltra-accent)"
                                    : "color-mix(in srgb, var(--color-voltra-text) 25%, transparent)"
                                }
                                width="18"
                                height="18"
                              >
